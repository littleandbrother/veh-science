...
def build_initial_program(task: DiscoverTaskCard, base_dir: str | Path | None = None) -> DiscoveryProgramState:
    """Build the initial replay/discover program state."""

    corpus_manifest = build_corpus_manifest(task, base_dir=base_dir)
    claim_graph = build_claim_graph(task, base_dir=base_dir)
